 ...
 *   <li>La valeur doit être {@code >= 0} — un niveau sonore ne peut pas être négatif.</li>
...
public class NoiseMeasure extends Measure {
	 ...
	 * @param unitString unité déclarée dans le message entrant ; doit être {@code "dB"}
	 * @throws InvalidMeasureException si {@code unitString} ne correspond pas à {@code "dB"}
	 */
	...
	/**
	 * Vérifie que le niveau sonore est présent et non négatif, puis valide le timestamp.
	 *
