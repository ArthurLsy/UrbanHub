 ...
 *   <li>La valeur doit être {@code >= 0} — une concentration ne peut pas être négative.</li>
...
public class AirMeasure extends Measure {
	 ...
	 * @param unitString unité déclarée dans le message entrant ; doit être {@code "μg/m3"}
	 * @throws InvalidMeasureException si {@code unitString} ne correspond pas à {@code "μg/m3"}
	 */
	...
	/**
	 * Vérifie que la concentration est présente et non négative, puis valide le timestamp.
	 *
