...
public class MesureController {
    ...
    /**
     * Retourne une mesure a partir de son identifiant technique.
     *
     * @param uuid identifiant technique de la mesure
     * @return la mesure correspondante
     */
    @GetMapping("/{uuid}")
    public MesureDto getMesureByUuid(@PathVariable UUID uuid) {
        return mesureService.getMesureByUuid(uuid);
    }
}
